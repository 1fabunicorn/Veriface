...
obama_image1 = face_recognition.load_image_file("../img/obama1.png")
obama_face_encoding1 = face_recognition.face_encodings(obama_image1)[0]

obama_image2 = face_recognition.load_image_file("../img/obama2.jpg")
obama_face_encoding2 = face_recognition.face_encodings(obama_image2)[0]

obama_image3 = face_recognition.load_image_file("../img/obama3.jpg")
